...
#import "ABI32_0_0EXAVPlayerData.h"

NSString *const ABI32_0_0EXAVPlayerDataStatusIsLoadedKeyPath = @"isLoaded";
NSString *const ABI32_0_0EXAVPlayerDataStatusURIKeyPath = @"uri";
NSString *const ABI32_0_0EXAVPlayerDataStatusHeadersKeyPath = @"headers";
NSString *const ABI32_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath = @"progressUpdateIntervalMillis";
NSString *const ABI32_0_0EXAVPlayerDataStatusDurationMillisKeyPath = @"durationMillis";
NSString *const ABI32_0_0EXAVPlayerDataStatusPositionMillisKeyPath = @"positionMillis";
NSString *const ABI32_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath = @"seekMillisToleranceBefore";
NSString *const ABI32_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath = @"seekMillisToleranceAfter";
NSString *const ABI32_0_0EXAVPlayerDataStatusPlayableDurationMillisKeyPath = @"playableDurationMillis";
NSString *const ABI32_0_0EXAVPlayerDataStatusShouldPlayKeyPath = @"shouldPlay";
NSString *const ABI32_0_0EXAVPlayerDataStatusIsPlayingKeyPath = @"isPlaying";
NSString *const ABI32_0_0EXAVPlayerDataStatusIsBufferingKeyPath = @"isBuffering";
NSString *const ABI32_0_0EXAVPlayerDataStatusRateKeyPath = @"rate";
NSString *const ABI32_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath = @"shouldCorrectPitch";
NSString *const ABI32_0_0EXAVPlayerDataStatusVolumeKeyPath = @"volume";
NSString *const ABI32_0_0EXAVPlayerDataStatusIsMutedKeyPath = @"isMuted";
NSString *const ABI32_0_0EXAVPlayerDataStatusIsLoopingKeyPath = @"isLooping";
NSString *const ABI32_0_0EXAVPlayerDataStatusDidJustFinishKeyPath = @"didJustFinish";
NSString *const ABI32_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath = @"hasJustBeenInterrupted";

NSString *const ABI32_0_0EXAVPlayerDataObserverStatusKeyPath = @"status";
NSString *const ABI32_0_0EXAVPlayerDataObserverRateKeyPath = @"rate";
NSString *const ABI32_0_0EXAVPlayerDataObserverCurrentItemKeyPath = @"currentItem";
NSString *const ABI32_0_0EXAVPlayerDataObserverTimeControlStatusPath = @"timeControlStatus";
NSString *const ABI32_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath = @"playbackBufferEmpty";

@interface ABI32_0_0EXAVPlayerData ()

@property (nonatomic, weak) ABI32_0_0EXAV *exAV;
...
@property (nonatomic, strong) ABI32_0_0RCTPromiseResolveBlock replayResolve;

@end

@implementation ABI32_0_0EXAVPlayerData

#pragma mark - Static methods

+ (NSDictionary *)getUnloadedStatus
{
  return @{ABI32_0_0EXAVPlayerDataStatusIsLoadedKeyPath: @(NO)};
}
         ...
         withLoadFinishBlock:(void (^)(BOOL success, NSDictionary *successStatus, NSString *error))loadFinishBlock
{
  if ((self = [super init])) {
    ...
    _url = [NSURL URLWithString:[source objectForKey:ABI32_0_0EXAVPlayerDataStatusURIKeyPath]];
    _headers = [self validatedRequestHeaders:source[ABI32_0_0EXAVPlayerDataStatusHeadersKeyPath]];
...
- (void)_loadNewPlayer
{
  ...
  [avAsset loadValuesAsynchronouslyForKeys:@[ @"duration" ] completionHandler:^{
    __weak ABI32_0_0EXAVPlayerData *strongSelf = weakSelf;
    if (strongSelf) {
      ...
      if (strongSelf.player) {
        [strongSelf.player addObserver:strongSelf forKeyPath:ABI32_0_0EXAVPlayerDataObserverStatusKeyPath options:0 context:nil];
        [strongSelf.player.currentItem addObserver:strongSelf forKeyPath:ABI32_0_0EXAVPlayerDataObserverStatusKeyPath options:0 context:nil];
      } else {
...
- (void)_finishLoadingNewPlayer
{
  ...
  [_player seekToTime:_currentPosition completionHandler:^(BOOL finished) {
    __strong ABI32_0_0EXAVPlayerData *strongSelf = weakSelf;
    __strong ABI32_0_0EXAV *strongEXAV = strongSelf ? strongSelf.exAV : nil;
    if (strongEXAV) {
      dispatch_async(strongEXAV.methodQueue, ^{
        __strong ABI32_0_0EXAVPlayerData *strongSelfInner = weakSelf;
        if (strongSelfInner) {
         ...
         rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject
{
  ...
  if ([parameters objectForKey:ABI32_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath] != nil) {
    NSNumber *progressUpdateIntervalMillis = parameters[ABI32_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath];
  ...
  if ([parameters objectForKey:ABI32_0_0EXAVPlayerDataStatusPositionMillisKeyPath] != nil) {
    NSNumber *currentPositionMillis = parameters[ABI32_0_0EXAVPlayerDataStatusPositionMillisKeyPath];
  ...
  if (mustSeek && [parameters objectForKey:ABI32_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath] != nil) {
    NSNumber *seekMillisToleranceBefore = parameters[ABI32_0_0EXAVPlayerDataStatusSeekMillisToleranceBeforeKeyPath];
  ...
  if (mustSeek && [parameters objectForKey:ABI32_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath] != nil) {
    NSNumber *seekMillisToleranceAfter = parameters[ABI32_0_0EXAVPlayerDataStatusSeekMillisToleranceAfterKeyPath];
    toleranceAfter = CMTimeMakeWithSeconds(seekMillisToleranceAfter.floatValue / 1000, NSEC_PER_SEC);
  }
  
  if ([parameters objectForKey:ABI32_0_0EXAVPlayerDataStatusShouldPlayKeyPath] != nil) {
    NSNumber *shouldPlay = parameters[ABI32_0_0EXAVPlayerDataStatusShouldPlayKeyPath];
    _shouldPlay = shouldPlay.boolValue;
  }
  
  if ([parameters objectForKey:ABI32_0_0EXAVPlayerDataStatusRateKeyPath] != nil) {
    NSNumber *rate = parameters[ABI32_0_0EXAVPlayerDataStatusRateKeyPath];
    _rate = rate;
  }
  if ([parameters objectForKey:ABI32_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath] != nil) {
    NSNumber *shouldCorrectPitch = parameters[ABI32_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath];
    _shouldCorrectPitch = shouldCorrectPitch.boolValue;
  }
  if ([parameters objectForKey:ABI32_0_0EXAVPlayerDataStatusVolumeKeyPath] != nil) {
    NSNumber *volume = parameters[ABI32_0_0EXAVPlayerDataStatusVolumeKeyPath];
    _volume = volume;
  }
  if ([parameters objectForKey:ABI32_0_0EXAVPlayerDataStatusIsMutedKeyPath] != nil) {
    NSNumber *isMuted = parameters[ABI32_0_0EXAVPlayerDataStatusIsMutedKeyPath];
    _isMuted = isMuted.boolValue;
  }
  if ([parameters objectForKey:ABI32_0_0EXAVPlayerDataStatusIsLoopingKeyPath] != nil) {
    NSNumber *isLooping = parameters[ABI32_0_0EXAVPlayerDataStatusIsLoopingKeyPath];
  ...
  if (_player && _isLoaded) {
    ...
    void (^applyPostSeekParameters)(BOOL) = ^(BOOL seekSucceeded) {
      ...
      if (strongSelf) {
        ...
        if (audioSessionError) {
          ...
          if (reject) {
            reject(@"E_AV_SEEKING", nil, ABI32_0_0RCTErrorWithMessage(@"Seeking interrupted."));
          }
        } else if (resolve) {
    ...
    if (resolve) {
      resolve([ABI32_0_0EXAVPlayerData getUnloadedStatus]);
    }
  }
}
...
- (NSDictionary *)getStatus
{
  if (!_isLoaded || _player == nil) {
    return [ABI32_0_0EXAVPlayerData getUnloadedStatus];
  }
  ...
  // TODO : ReactABI32_0_0-native-video includes the iOS-only keys seekableDuration and canReverse (etc) flags.
  //        Consider adding these.
  NSMutableDictionary *mutableStatus = [@{ABI32_0_0EXAVPlayerDataStatusIsLoadedKeyPath: @(YES),
                                          
                                          ABI32_0_0EXAVPlayerDataStatusURIKeyPath: [_url absoluteString],
                                          
                                          ABI32_0_0EXAVPlayerDataStatusProgressUpdateIntervalMillisKeyPath: _progressUpdateIntervalMillis,
                                          // positionMillis, playableDurationMillis, and durationMillis may be nil and are added after this definition.
                                          
                                          ABI32_0_0EXAVPlayerDataStatusShouldPlayKeyPath: @(_shouldPlay),
                                          ABI32_0_0EXAVPlayerDataStatusIsPlayingKeyPath: @(isPlaying),
                                          ABI32_0_0EXAVPlayerDataStatusIsBufferingKeyPath: @(isBuffering),
                                          
                                          ABI32_0_0EXAVPlayerDataStatusRateKeyPath: _rate,
                                          ABI32_0_0EXAVPlayerDataStatusShouldCorrectPitchKeyPath: @(_shouldCorrectPitch),
                                          ABI32_0_0EXAVPlayerDataStatusVolumeKeyPath: @(_player.volume),
                                          ABI32_0_0EXAVPlayerDataStatusIsMutedKeyPath: @(_player.muted),
                                          ABI32_0_0EXAVPlayerDataStatusIsLoopingKeyPath: @(_isLooping),
                                          
                                          ABI32_0_0EXAVPlayerDataStatusDidJustFinishKeyPath: @(NO),
                                          ABI32_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath: @(NO),
                                          } mutableCopy];
  
  mutableStatus[ABI32_0_0EXAVPlayerDataStatusPlayableDurationMillisKeyPath] = playableDurationMillis;
  mutableStatus[ABI32_0_0EXAVPlayerDataStatusDurationMillisKeyPath] = durationMillis;
  mutableStatus[ABI32_0_0EXAVPlayerDataStatusPositionMillisKeyPath] = positionMillis;
                ...
                rejecter:(ABI32_0_0RCTPromiseRejectBlock)reject
{
  [self _callStatusUpdateCallbackWithExtraFields:@{
                                                   ABI32_0_0EXAVPlayerDataStatusHasJustBeenInterruptedKeyPath: @([self _isPlayerPlaying]),
                                                   }];
...
{
  [self _tryRemoveObserver:_player forKeyPath:ABI32_0_0EXAVPlayerDataObserverStatusKeyPath];
  
  for (AVPlayerItem *item in _items) {
    [self _removeObserversForPlayerItem:item];
  }
  
  [self _tryRemoveObserver:_player forKeyPath:ABI32_0_0EXAVPlayerDataObserverRateKeyPath];
  [self _tryRemoveObserver:_player forKeyPath:ABI32_0_0EXAVPlayerDataObserverCurrentItemKeyPath];
  [self _tryRemoveObserver:_player forKeyPath:ABI32_0_0EXAVPlayerDataObserverTimeControlStatusPath];
}
...
{
  [self _tryRemoveObserver:playerItem forKeyPath:ABI32_0_0EXAVPlayerDataObserverStatusKeyPath];
  ...
  [self _tryRemoveObserver:playerItem forKeyPath:ABI32_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath];
}
...
- (void)_addObserversForPlayerItem:(AVPlayerItem *)playerItem
{
  ...
  void (^didPlayToEndTimeObserverBlock)(NSNotification *note) = ^(NSNotification *note) {
    ...
    if (strongEXAV) {
      dispatch_async(strongEXAV.methodQueue, ^{
        ...
        if (strongSelfInner) {
          [strongSelfInner _callStatusUpdateCallbackWithExtraFields:@{ABI32_0_0EXAVPlayerDataStatusDidJustFinishKeyPath: @(YES)}];
          ...
          if (!strongSelfInner.isLooping) {
            ...
            __strong ABI32_0_0EXAV *strongEXAVInner = strongSelfInner.exAV;
            if (strongEXAVInner) {
  ...
  [self _tryRemoveObserver:playerItem forKeyPath:ABI32_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath];
  [playerItem addObserver:self forKeyPath:ABI32_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath options:0 context:nil];
  
  [self _tryRemoveObserver:playerItem forKeyPath:ABI32_0_0EXAVPlayerDataObserverStatusKeyPath];
  [playerItem addObserver:self forKeyPath:ABI32_0_0EXAVPlayerDataObserverStatusKeyPath options:0 context:nil];
}
...
- (void)_updateTimeObserver
{
  ...
  void (^timeObserverBlock)(CMTime time) = ^(CMTime time) {
    ...
    __strong ABI32_0_0EXAV *strongEXAV = strongSelfOuter ? strongSelfOuter.exAV : nil;
...
- (void)_addObserversForNewPlayer
{
  ...
  [_player addObserver:self forKeyPath:ABI32_0_0EXAVPlayerDataObserverRateKeyPath options:0 context:nil];
  NSUInteger currentItemObservationOptions = NSKeyValueObservingOptionOld | NSKeyValueObservingOptionNew;
  [_player addObserver:self forKeyPath:ABI32_0_0EXAVPlayerDataObserverCurrentItemKeyPath options:currentItemObservationOptions context:nil];
  [_player addObserver:self forKeyPath:ABI32_0_0EXAVPlayerDataObserverTimeControlStatusPath options:0 context:nil]; // Only available after iOS 10
                       ...
                       context:(void *)context
{
  ...
  __weak ABI32_0_0EXAVPlayerData *weakSelf = nil;
  ...
  // as the ABI32_0_0EXAVPlayerData is being deallocated, so let's early return.
  //
  ...
  __strong ABI32_0_0EXAV *strongEXAV = _exAV;
  if (strongEXAV == nil) {
    return;
  }
  ...
  dispatch_async(strongEXAV.methodQueue, ^{
    ...
    if (strongSelf) {
      if (object == strongSelf.player) {
        if ([keyPath isEqualToString:ABI32_0_0EXAVPlayerDataObserverStatusKeyPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI32_0_0EXAVPlayerDataObserverRateKeyPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI32_0_0EXAVPlayerDataObserverTimeControlStatusPath]) {
        ...
        } else if ([keyPath isEqualToString:ABI32_0_0EXAVPlayerDataObserverCurrentItemKeyPath]) {
        ...
        if ([keyPath isEqualToString:ABI32_0_0EXAVPlayerDataObserverStatusKeyPath]) {
          ...
          [strongSelf _callStatusUpdateCallback];
        } else if ([keyPath isEqualToString:ABI32_0_0EXAVPlayerDataObserverPlaybackBufferEmptyKeyPath]) {
          [strongSelf _callStatusUpdateCallback];
        }
      }
    }
...
#pragma mark - ABI32_0_0EXAVObject
...
- (ABI32_0_0EXAVAudioSessionMode)getAudioSessionModeRequired
{
  if (_player && ([self _isPlayerPlaying] || [self _shouldPlayerPlay])) {
    return _isMuted ? ABI32_0_0EXAVAudioSessionModeActiveMuted : ABI32_0_0EXAVAudioSessionModeActive;
  }
  return ABI32_0_0EXAVAudioSessionModeInactive;
}
...
{
  // ABI32_0_0EXAudio already forced pause.
}
